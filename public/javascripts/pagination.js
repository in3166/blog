...
function pagination(a) {
    ...
    jQuery('.pagination1').append("<li class=\"page-item disabled\"><a class=\"page-link first\">First</a></li>");
    jQuery('.pagination1').append("<li class=\"page-item\"><a class=\"page-link prev\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>");

    for (var i = 1; i <= num; i++) {
        jQuery('.pagination1').append("<li class=\"page-item\"><a class=\"page-link page-num\">" + i + "</a></li>");
        jQuery('.pagination1 li:nth-child(3)').addClass("active");
        jQuery('.page-num').addClass("pagination-link");
    }

    jQuery('.pagination1').append("<li class=\"page-item\"><a class=\"page-link next\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li>");
    jQuery('.pagination1').append("<li class=\"page-item\"><a class=\"page-link last\">Last</a></li>");
    ...
    if (num_pages == 1 || num_pages == 0) {
        ...
        jQuery('.pagination1 li:first-child').next().addClass("disabled");
        jQuery('.pagination1 li:last-child').addClass("disabled");
        jQuery('.pagination1 li:last-child').prev().addClass("disabled");
    }
    ...
    jQuery('.first').click(function (e) {
        ...
        for (let index = 0; index < visiblePages - 1; index++) {
        ...
        jQuery('.pagination1 li:first-child').next().next().addClass("active");
        jQuery('.pagination1 li:first-child').removeClass("active");
    ...
    jQuery('.last').click(function (e) {
        ...
        if (cm1 == 0) {
            ...
            for (let index = visiblePages - 1; index >= 0; index--) {
                ...
                jQuery('.pagination1 li').eq(visiblePages + 1).addClass("active");
                i++;
            }
        } else {
            for (let index = 0; index < visiblePages; index++) {
                ...
                if (index >= visiblePages - (visiblePages - cm1)) {
                    ...
                    if (current_page + index + 1 == endPage) jQuery('.pagination1 li').eq(cm1 + 1).addClass("active");
                }
            }
        }
    ...
    function chkDisabled(current_num) {
        if (current_num == 0) {
            jQuery('.pagination1 li:first-child').addClass("disabled");
            jQuery('.pagination1 li:first-child').next().addClass("disabled");
            jQuery('.pagination1 li:last-child').removeClass("disabled");
            jQuery('.pagination1 li:last-child').prev().removeClass("disabled");
